  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-current'>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          ...
          <p className='text-current'>We’re committed to quality in every product we offer, ensuring durability, style, and satisfaction. Each item is carefully selected and tested to meet our high standards, so you can shop with confidence every time.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenience :</b> 
          <p className='text-current'>We prioritize your convenience with an easy-to-navigate platform, secure payments, and fast delivery, making shopping seamless from start to finish</p>
        </div> 
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Exceptional Customre Service :</b> 
          <p className='text-current'>We pride ourselves on exceptional customer service, ensuring every question is answered and every need is met. Your satisfaction is our priority!</p>
        </div> 
